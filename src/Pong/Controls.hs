...
handleEvents (EventKey (Char 'p') Down _ _) (GameInProgress game@Game {..}) =
...
handleEvents (EventKey (Char 's') keyState _ _) (GameInProgress game@Game {..}) =
  GameInProgress
    game {gameLeftPlayer = handleMoveKey DownM keyState gameLeftPlayer}
handleEvents (EventKey (Char 'w') keyState _ _) (GameInProgress game@Game {..}) =
  GameInProgress
    game {gameLeftPlayer = handleMoveKey UpM keyState gameLeftPlayer}
handleEvents (EventKey (SpecialKey KeyUp) keyState _ _) (GameInProgress game@Game {..}) =
  GameInProgress
    game {gameRightPlayer = handleMoveKey UpM keyState gameRightPlayer}
handleEvents (EventKey (SpecialKey KeyDown) keyState _ _) (GameInProgress game@Game {..}) =
  GameInProgress
    game {gameRightPlayer = handleMoveKey DownM keyState gameRightPlayer}
